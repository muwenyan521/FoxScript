...
Public Class Data
    ...
    Public isReadonly As Boolean '是否为只读
...
Public Class Environment
    ...
    Public Function GetObjects()
        Dim objs As New List(Of Fox_Object)
        For Each data As Data In store.Values
            objs.Add(data.FoxObject)
        Next
...
Public Class ClassEnvironment
    ...
    'Public Vars As New Dictionary(Of String, Data)
    'Public Funcs As New Dictionary(Of String, Data)
    'Public Classes As New Dictionary(Of String, Data)
End Class
